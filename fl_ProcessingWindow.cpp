...
Fl_ProcessingWindow::Fl_ProcessingWindow( int w, int h, const char* label, const Projections& projections, Fl_MainWindow* const main_window ) :
	...
	mu_water_input_{										X( processing_properties_group_, .6 ),		Y( processing_properties_group_, 0. ),		W( processing_properties_group_, .3 ),		H( processing_properties_group_, 1. ), "�_0 water" },
