...
quality( ForceRange( simulation_quality, 0ull, 49ull) ),
...
size_t SimulationProperties::Serialize( vector<char>& binary_data ) const{
	...
	num_bytes += SerializeBuildIn<size_t>( number_of_points_in_spectrum_, binary_data );
...
SimulationProperties::SimulationProperties( const vector<char>& binary_data, vector<char>::const_iterator& current_byte ) : 
	...
	number_of_points_in_spectrum_( DeSerializeBuildIn<size_t>( 32, binary_data, current_byte ) ),
