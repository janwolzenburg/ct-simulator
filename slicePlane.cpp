...
SlicePlane::SlicePlane( const vector<char>& binary_data, vector<char>::const_iterator& it ) :
	...
	rotation_angle_x( DeSerializeBuildIn<double>( (double) 0., binary_data, it ) ),
	rotation_angle_y( DeSerializeBuildIn<double>( (double) 0., binary_data, it ) ),
	position_z( DeSerializeBuildIn<double>( (double) 0., binary_data, it ) )
{}
...
size_t SlicePlane::Serialize( vector<char>& binary_data ) const{
	...
	num_bytes += SerializeBuildIn( rotation_angle_x, binary_data );
	num_bytes += SerializeBuildIn( rotation_angle_y, binary_data );
	num_bytes += SerializeBuildIn( position_z, binary_data );
