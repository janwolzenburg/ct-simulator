...
constexpr size_t number_of_points_in_tube_spectrum_ = 32;		/*!< Amount of discrete datapoints in spectrum*/

constexpr size_t number_of_scatter_angles = 63;								/*!< Amount of discrete angles available for scattering - should be odd to include 0°*/
