...
detectorRadonParameter::detectorRadonParameter( const idx2CR numberPoints_, const double distanceRange_ ) :
	...
	framesToFillSinogram( numberPoints.col - 1 + numberPoints.row )
{}
	...
	structured( indipendentParameter.structured )
{
	...
	if( recalculate != 0 ){
		...
		radonParameter.framesToFillSinogram = radonParameter.numberPoints.col - 1 + radonParameter.numberPoints.row;
